...
export const metadata:Metadata={title:"Gakuran Guides: Combat, Controls & Character Wiki",description:"Browse Gakuran guides for fighting styles, controls, character creation, faces, ethnicity, hairstyles, hair colors, surnames and community links."};
const groups=[
